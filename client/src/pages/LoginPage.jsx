    ...
    <div className="min-h-screen bg-[#f1f3f6] flex items-center justify-center px-4">
      <div className="flex w-full max-w-3xl shadow-lg rounded-sm overflow-hidden">
        <div className="bg-[#2874f0] text-white p-10 w-5/12 hidden md:flex flex-col justify-between">
          <div>
            ...
            <p className="text-blue-200 text-sm leading-relaxed">
              Login is not required in this demo. You are already using the app as the default user.
            </p>
          </div>
          <img
        ...
        <div className="bg-white flex-1 p-8 flex flex-col justify-center">
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">No login required</h2>
          <p className="text-sm text-gray-600 mb-6 leading-relaxed">
            This project runs in no-login mode for the assignment. A default user is already active,
            so you can browse products, add items to cart, place orders, and use wishlist directly.
          </p>
